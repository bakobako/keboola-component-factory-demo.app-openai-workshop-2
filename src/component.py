...
class Component(ComponentBase):
    ...
    def run(self):
        ...
        out_columns = input_table.columns + ["open_ai_output"]
        out_table = self.create_out_table_definition("analyzed_output", columns=out_columns)

        analyze_messages_in_file(in_file_name=input_table.full_path, text_column=text_column,
                                 out_file_name=out_table.full_path, out_file_columns=out_columns,
